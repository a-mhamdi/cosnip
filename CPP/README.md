...
| File                | Topic |
|---------------------|---|
| `01_hello_world.cpp` | First program, `cout`, compilation basics |
| `02_variables.cpp`  | Types, `const`, `auto`, initialization |
| `03_conditionals.cpp` | `if / else if / else`, ternary, `switch` |
| `04_loops.cpp`      | `for`, `while`, `do-while`, `break`, `continue` |
